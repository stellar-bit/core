...
impl ComponentType {
    ...
    pub fn health(&self) -> f32 {
        match &self {
            ComponentType::Central => 20000.,
            ComponentType::SteelBlock => 10000.,
            ComponentType::RaptorEngine => 15000.,
            ComponentType::LaserWeapon => 5000.,
            ComponentType::MissileLauncher => 10000.,
        }
    }
    pub fn scale(&self) -> UVec2 {
        match self {
